package com.example.inirv.LoginAndCreateAccount
...
class LoginActivity : AppCompatActivity(){
    ...
    fun confirmPressed(view: View){
        ...
        // Set the views
        val emailET = findViewById<EditText>(R.id.login_email_edit_text)
        val passwordET = findViewById<EditText>(R.id.login_password_edit_text)
